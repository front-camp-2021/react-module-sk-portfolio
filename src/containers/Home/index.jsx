...
export function Home() {
    ...
    const isNeededPagination = numberOfPages(productsList, NUMBER_OF_PRODUCTS_ONE_PAGE) > 1
    return (
        ...
        <div className="container ">
            <div className="products-list__inner" data-element="mainWrapper">
                ...
                <div className="products products-list__main">
                    ...
                    <CardList products={productsList} filteredProducts={productsList}/>
                    { isNeededPagination ? <Pagination numberOfPages={numberOfPages(productsList, NUMBER_OF_PRODUCTS_ONE_PAGE)} /> : null }
